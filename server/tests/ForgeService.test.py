...
class TestForgeService(unittest.TestCase):
    ...
    def test_method1(self):
        # Test the 'method1' function in the 'ForgeService' class
        result = self.service.method1()
        self.assertEqual(result, expected_output)

    def test_method2(self):
        # Test the 'method2' function in the 'ForgeService' class
        result = self.service.method2()
        self.assertEqual(result, expected_output)
